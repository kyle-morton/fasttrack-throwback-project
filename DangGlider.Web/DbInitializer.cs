...
namespace DangGlider.Web.Core.Data
{
    public static class DbInitializer
    {
        public static void Populate(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            {
                SeedData(serviceScope.ServiceProvider.GetService<DangGliderDbContext>(), env);
            }
        }

        private static void SeedData(DangGliderDbContext context, IWebHostEnvironment env)
        {
            if (env.IsProduction())
            {
